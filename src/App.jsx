...
function Av({name,color,size=44}){return <div style={{position:'relative',width:size,height:size,flexShrink:0,display:'inline-flex',alignItems:'center',justifyContent:'center',borderRadius:'50%',boxShadow:'0 3px 10px rgba(0,0,0,0.30)',overflow:'hidden'}}><img src='/golf_ball.webp' alt='' style={{width:'100%',height:'100%',objectFit:'cover',display:'block'}}/><span style={{position:'absolute',top:'50%',left:'50%',transform:'translate(-50%,-50%)',color:'#1a5c38',fontWeight:700,fontSize:size/2.5,lineHeight:1,pointerEvents:'none',userSelect:'none'}}>{ini(name)}</span></div>}
