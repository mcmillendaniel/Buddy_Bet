...
function Av({name,color,size=44}){return <div style={{position:'relative',width:size,height:size,flexShrink:0,display:'inline-flex',alignItems:'center',justifyContent:'center'}}><img src='/golf_ball.webp' alt='' style={{width:size,height:size,filter:'drop-shadow(0 2px 6px rgba(0,0,0,0.25))',display:'block'}}/><span style={{position:'absolute',top:'50%',left:'50%',transform:'translate(-50%,-50%)',color:'#1a5c38',fontWeight:700,fontSize:size/2.5,lineHeight:1,pointerEvents:'none',userSelect:'none'}}>{ini(name)}</span></div>}
